  ...
  return (
    <html lang="en" className={inter.variable}>
      <head>
        ...
        <link rel="preload" href="/media/posters/intro-101.jpg" as="image" type="image/jpeg" fetchPriority="high" />
        <link rel="preload" href="/media/intro-101.mp4" as="video" type="video/mp4" />
